    ...
    <div className="container mx-auto px-6 py-8">
      ...
      {cart.length === 0 ? (
        ...
        <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg">
          ...
          <input type="text" placeholder="Shipping Address" value={address} onChange={(e) => setAddress(e.target.value)} className="w-full border p-2 rounded mb-4" />
          <button onClick={handleCheckout} disabled={loading} className={`bg-green-600 text-white px-6 py-3 rounded w-full ${loading ? "opacity-50 cursor-not-allowed" : "hover:bg-green-700"}`}>
